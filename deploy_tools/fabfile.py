...
REPO_URL = 'git@bitbucket.org:ingeniarte/lab7.git'
PROJECT = 'lab7'  # nombre de carpeta donde esta wsgi 

# CREATE DATABASE db;
# CREATE USER user WITH PASSWORD 'pass';
# GRANT ALL PRIVILEGES ON DATABASE db TO user;

# sudo certbot certonly --cert-name domain --webroot -w /home/user/sites/site_name -d domain

ENVIROMENT_SETTINGS = {
    'production': {
        'site': 'lab7',
        'branch': 'master',
        'allowed_host': '190.14.229.107'
    },
    'staging': {
        'site': 'lab7_staging',
        'branch': 'master',
...
def set_env_variables():
    ...
    append(ENV_FILE, 'export DATABASE_URL=psql://{}'.format(get_database_url()))
...
def provision():
    ...
    for subfolder in ('static', 'media/barcode', 'src', 'bin', 'tmp/sockets', 'tmp/logs'):
